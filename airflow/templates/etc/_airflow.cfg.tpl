...
# values at runtime)
{{ if not .default.core.unit_test_mode }}#{{ end }}unit_test_mode = {{ .default.core.unit_test_mode | default "False" }}
...
{{ if not .default.cli.endpoint_url }}#{{ end }}endpoint_url = {{ .default.cli.endpoint_url | default "http://web.airflow:8080" }}
...
# privacy.
{{ if not .default.webserver.demo_mode }}#{{ end }}demo_mode = {{ .default.webserver.demo_mode | default "False" }}
...
# DAGs by default
{{ if not .default.webserver.hide_paused_dags_by_default }}#{{ end }}hide_paused_dags_by_default = {{ .default.webserver.hide_paused_dags_by_default | default "False" }}
...
{{ if not .default.scheduler.authenticate }}#{{ end }}authenticate = {{ .default.scheduler.authenticate | default "False" }}
